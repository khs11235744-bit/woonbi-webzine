...
const media={
 school:{path:'assets/media/school.webp',width:1200,height:477,bytes:84218,label:'지난 호 학교 자료사진'},
 sports:{path:'assets/media/sports.webp',width:1200,height:325,bytes:82854,label:'지난 호 체육·활동 자료사진'},
 marathon:{path:'assets/media/marathon.webp',width:1200,height:470,bytes:58128,label:'지난 호 마라톤 자료사진'},
 busking:{path:'assets/media/busking.webp',width:666,height:502,bytes:42174,label:'지난 호 공연·문화 자료사진'},
 trip:{path:'assets/media/trip.webp',width:643,height:387,bytes:25794,label:'지난 호 기행 자료사진'},
 camp:{path:'assets/media/camp.webp',width:668,height:379,bytes:13126,label:'지난 호 캠프·활동 자료사진'},
 exchange:{path:'assets/media/exchange.webp',width:1200,height:470,bytes:81254,label:'지난 호 국제교류 자료사진'},
 library:{path:'assets/media/library.webp',width:633,height:850,bytes:115868,label:'지난 호 도서·인터뷰 자료사진'},
 science:{path:'assets/media/science.webp',width:1200,height:616,bytes:48864,label:'지난 호 과학·탐구 자료사진'},
 memories:{path:'assets/media/memories.webp',width:669,height:552,bytes:83564,label:'지난 호 학교생활 자료사진'}
};
